    ...
    <section className="jason">
      <div className="max-w-lg jason-content">
        ...
        <div className="jason-2">
          <img src="/images/jason-2.webp" alt="Jason Duval portrait 2" />
        </div>
      </div>

      <div className="space-y-5 mt-96 img-box">
        <div className="jason-1">
          <img src="/images/jason-1.webp" alt="Jason Duval portrait 1" />
        </div>
        <div className="jason-3">
          <img src="/images/jason-3.webp" alt="Jason Duval portrait 3" />
        </div>
      </div>
    </section>
  )
